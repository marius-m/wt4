...
//        implements DBIndexable, DBPackable, DBUnpackable, DBIndexUpdatable
{
...
//  @Override
  public String indexClause() {
    return "_id = '" + _id + "'";
  }

//  @Override
  public Map<String, Object> pack() throws IllegalArgumentException {
    return new LinkedHashMap<String, Object>();
  }

//  @Override
  public void unpack(ResultSet resultSet) throws IllegalArgumentException, SQLException {
