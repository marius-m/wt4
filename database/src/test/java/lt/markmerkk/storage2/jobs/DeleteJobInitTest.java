 ...
 */
public class DeleteJobInitTest {
  @Test public void testNullClass() throws Exception {
    // Arrange
    // Act
    // Assert
    try {
      new DeleteJob(null, mock(Mock4.class));
  ...
  @Test public void testNullEntity() throws Exception {
    ...
    // Assert
    try {
      new DeleteJob(Mock4.class, null);
      fail("Should not create a class with null input");
    } catch (IllegalArgumentException e) {
      assertThat(e.getMessage()).isEqualTo("Cannot create job without an index");
    }
  }
  ...
  @Test public void testValid() throws Exception {
    ...
    // Act
    // Assert
    new DeleteJob(Mock4.class, mock(Mock4.class));
  }
}