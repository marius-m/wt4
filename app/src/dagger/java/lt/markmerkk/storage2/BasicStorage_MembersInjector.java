...
public final class BasicStorage_MembersInjector implements MembersInjector<BasicLogStorage> {
  private final Provider<DBProdExecutor> executorProvider;

  public BasicStorage_MembersInjector(Provider<DBProdExecutor> executorProvider) {  
  ...
  public static MembersInjector<BasicLogStorage> create(Provider<DBProdExecutor> executorProvider) {
      return new BasicStorage_MembersInjector(executorProvider);
  }
}
