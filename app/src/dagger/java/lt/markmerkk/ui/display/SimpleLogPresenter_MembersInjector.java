...
public final class SimpleLogPresenter_MembersInjector implements MembersInjector<SimpleLogPresenter> {
  ...
  @Override
  public void injectMembers(SimpleLogPresenter instance) {  
    if (instance == null) {
  ...
  public static MembersInjector<SimpleLogPresenter> create(Provider<BasicLogStorage> storageProvider) {  
