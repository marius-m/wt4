...
public final class DisplayLogPresenter_MembersInjector implements MembersInjector<DisplayLogPresenter> {
  private final Provider<BasicLogStorage> storageProvider;

  public DisplayLogPresenter_MembersInjector(Provider<BasicLogStorage> storageProvider) {  
  ...
  public static MembersInjector<DisplayLogPresenter> create(Provider<BasicLogStorage> storageProvider) {  
      return new DisplayLogPresenter_MembersInjector(storageProvider);
  }
}
